...
public class KeyValueNodeStandardDeviation {
    ...
    public static void main(String[] args) {
        SimpleConsistenceHash consistentHash = new SimpleConsistenceHash(NODES);
        ...
        for (int i = 0; i < keyValueCount; i++) {
            ...
            String nodeIp = consistentHash.getNode(String.valueOf(nextId));;
        ...
        System.out.println(compute(nodeCounts.values(), keyValueCount, NODES.size()));
    }
