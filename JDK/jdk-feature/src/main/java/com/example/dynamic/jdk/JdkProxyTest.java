...
//        for(int i =0; i< 17; i++){
//            Class.forName("com.jdk14.com.example.dynamic.myjdk.Zhangsan").getConstructor().newInstance();
//        }
             Method method = Class.forName("com.example.dynamic.myjdk.Zhangsan").getMethod("findObject");
...
//      System.setProperty("dk.proxy.ProxyGenerator.saveGeneratedFiles","true");
        ...
        for(int i=0; i <=16; i++) {
            if(16 == i) {
                Class.forName("com.example.dynamic.myjdk.Zhangsan").getField("test");
            }
        }
    }
